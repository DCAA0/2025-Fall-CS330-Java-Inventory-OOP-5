...
public class Tool extends Equippable implements Item {
    ...
    {
        // Refer to the previous assignment
        return this.getName().hashCode() + this.getSpeed() + this.getMaterial().hashCode() + this.getModifier().hashCode() + 
    ...
    public String toString()
    {
        return String.format(FMT_STR, 
            this.getName(), this.getDurability(), this.getSpeed(), this.getMaterial(), this.getModifier(), 
                this.getModifierLevel());
    }
}
